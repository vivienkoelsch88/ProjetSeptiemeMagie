...
public class VillagePecheurMagasin extends Villes implements PanelInterface, KeyListener, ActionListener, MouseListener {
    private VillagePecheursEntree entree;

    public VillagePecheurMagasin(Fenetre fen, VillagePecheursEntree entree, Personnage personnage) {
        super(new String[]{
                "/Pan/Lieux/Villes/VillagePecheur/fondEcran/Magasin.jpg"
        }, new JButton[]{
                new JButton("Taverne"), new JButton("Grande place"), new JButton("Entree")
        }, fen
        ,personnage);
