...
public class VillagePecheurTaverne extends Villes implements PanelInterface, KeyListener, ActionListener, MouseListener {
        private VillagePecheursEntree entree;

    public VillagePecheurTaverne(Fenetre fen, VillagePecheursEntree entree, Personnage personnage) {
        super(new String[]{
                        "/Pan/Lieux/Villes/VillagePecheur/fondEcran/taverne.jpg"
                }, new JButton[]{
                        new JButton("Grande place"), new JButton("Magasin"), new JButton("Entree")
                }, fen
                ,personnage
        );
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(source == super.getBoutons()[2]) {
            ...
            this.entree.deplacerGrandPlace();
